...
<nav style="margin: 0; padding:0;" class="navbar navbar-main navbar-expand-lg px-0 mx-4 mb-6 shadow-none border-radius-xl
        {{ str_contains(Request::url(), 'virtual-reality') == true ? ' mt-3 mx-3 bg-primary' : '' }}"
    id="navbarBlur" data-scroll="false">

    <div class="nabbar container-fluid py-0 px-3 ms-2 d-flex justify-content-between">
        ...
        <div class="d-flex align-items-center me-5" >
            ...
            <div class="d-flex align-items-center text-white dropdown btn-group mt-3 me-5">
