<div class="card mx-5 mb-2">
    ...
    <input type="text" class="block text-black-600 font-medium rounded-lg text-sm px-5 py-2.5 text-start custom-button"
        placeholder="What's on your mind?" data-bs-toggle="modal" data-bs-target="#staticBackdrop" readonly>
